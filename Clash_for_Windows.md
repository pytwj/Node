...
- {name: 🇭🇰 日本00-香港中转-电信优化, server: 39.sufeiyun.cyou, port: 17809, type: vmess, uuid: 30ebb148-1fd9-3422-9b2e-7a1f19618762, alterId: 2, cipher: auto, tls: false, skip-cert-verify: false}
- {name: 🇭🇰 韩国首尔2-香港中转-电信优化, server: 14.sufeiyun.cyou, port: 17783, type: vmess, uuid: 30ebb148-1fd9-3422-9b2e-7a1f19618762, alterId: 2, cipher: auto, tls: false, skip-cert-verify: false}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
  ...
  - name: 漏网之鱼
    ...
    proxies:
      ...
      - 🚀 节点选择
rules:
  - DOMAIN-KEYWORD,edu.daydayupedu.xyz,🚀 节点选择
  - DOMAIN-KEYWORD,fast.com,🚀 节点选择
  - DOMAIN-KEYWORD,github.com,🚀 节点选择
  - DOMAIN-KEYWORD,ant.design,🚀 节点选择
  - DOMAIN-KEYWORD,edu.lovess.top,🚀 节点选择
  - DOMAIN-KEYWORD,stackoverflow.com,🚀 节点选择
  - DOMAIN-KEYWORD,codekon.xyz,🚀 节点选择
  - DOMAIN-KEYWORD,mongoosejs.com,🚀 节点选择
  - DOMAIN-KEYWORD,sentry.io,🚀 节点选择
  - DOMAIN-KEYWORD,npmjs.com,🚀 节点选择
  - DOMAIN-KEYWORD,hapi.dev,🚀 节点选择
  - DOMAIN-KEYWORD,mongoosejs.com,🚀 节点选择
  - DOMAIN-KEYWORD,redux.js.org,🚀 节点选择
  - DOMAIN-KEYWORD,react-redux.js.org,🚀 节点选择
  - DOMAIN-KEYWORD,eslint.org,🚀 节点选择
  - DOMAIN-KEYWORD,restfulapi.net,🚀 节点选择
  - DOMAIN-KEYWORD,lodash.com,🚀 节点选择
  - DOMAIN-KEYWORD,vip.600mbps.xyz,🚀 节点选择
  ...
  - DOMAIN-SUFFIX,optimizely.com,🌍 国外媒体
